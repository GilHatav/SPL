...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private  MessageBroker tmp = MessageBrokerImpl.getInstance();
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        tmp.subscribeBroadcast(type,this);
        CallBackMap.put(type,callback);
    }
     ...
     *               {@code e}.
     */
    protected final <T> void complete(Event<T> e, T result) { tmp.complete(e,result);}
    ...
    /**
     * operates the callBack on message
     */
    public void doCallback(Message msg)
    {
